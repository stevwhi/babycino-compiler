...
public interface MiniJavaListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by the {@code ExpEqual}
	 * labeled alternative in {@link MiniJavaParser#expression}.
	 * @param ctx the parse tree
	 */
	void enterExpEqual(MiniJavaParser.ExpEqualContext ctx);
	/**
	 * Exit a parse tree produced by the {@code ExpEqual}
	 * labeled alternative in {@link MiniJavaParser#expression}.
	 * @param ctx the parse tree
	 */
	void exitExpEqual(MiniJavaParser.ExpEqualContext ctx);
	/**
