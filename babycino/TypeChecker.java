...
public class TypeChecker extends MiniJavaBaseListener {
	...
	@Override 
	public void exitExpEqual(MiniJavaParser.ExpEqualContext ctx){
		Type rhs = this.types.pop();
		Type lhs = this.types.pop();
		this.check(lhs.compatibleWith(rhs), ctx, "Incompatible type error in equals expression: " 		+ lhs + " and " + rhs);
